...
<div class="form-wrapper">
    ...
    <?php if($this->session->flashdata('chai')): ?>
        <div class="alert alert-danger"><?= $this->session->flashdata('chai') ?></div>
    <?php endif ?>
    
    <?php if($this->session->flashdata('phone')): ?>
        <div class="alert alert-danger"><?= $this->session->flashdata('phone') ?></div>
    <?php endif ?>


    <h5>Change Mobile number</h5>

    <!-- form -->
    <form action="<?= base_url('admin/home/phone') ?>" method="POST">
